...
class AgregarCita extends Component {
    ...
    propietarioaRef = React.createRef();
    ...
    crearNuevaCita = (e) => {
        ...
        const mascota = this.nombreMascotaRef.current.value,
            propietario = this.propietarioaRef.current.value,
                ...
                <div className="card-body">
                    ...
                    <form onSubmit={this.crearNuevaCita} >
                        ...
                        <div className="form-group row">
                            ...
                            <div className="col-sm-8 col-lg-10">
                                <input ref={this.propietarioaRef} type="text" className="form-control"  placeholder="Nombre Dueño de la Mascota" />
                            </div>
                        </div>
